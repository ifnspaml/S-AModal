...
class YTVISeval:
    ...
    def evaluate(self):
        ...
        #print('self.ious is', self.ious, flush=True)
    ...
    def computeIoU(self, vidId, catId):
        ...
        dt = [dt[i] for i in inds]#sort the predictions by score
    ...
    def summarize(self):
        ...
        def _summarize(ap=1, iouThr=None, areaRng='all', occRng='all', maxDets=100):
            ...
            if ap == 1:
                ...
                #this calculates per class AP, we do not need this
                # for i in range(s.shape[2]):
                #     s_cls = s[:, :, i, :]
                #     mean_s_cls = np.mean(s_cls[s_cls > -1])
                #     print('s shape', s.shape, flush=True)
                #     print('self.cocoGt.cats', self.cocoGt.cats, flush=True)

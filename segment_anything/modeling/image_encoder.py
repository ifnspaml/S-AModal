...
class ImageEncoderViT(nn.Module):
    def __init__(
        ...
        if 'adapt' in args['mode']:  # changed from original to allow for adapters
            block_class = AdapterBlock
            self.adapter = False
        elif 'samadpt' in args['mode']:  # changed from original to allow for adapters
            block_class = Block
            self.adapter = True
        else:
            block_class = Block
        ...
        self.prompt_generator = PromptGenerator(self.scale_factor, self.prompt_type, embed_dim,
                                                ...
                                                self.handcrafted_tune, self.embedding_tune, self.adapter,
                                                img_size, patch_size)
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        # adapter options added
        # adaptation from https://github.com/tianrun-chen/SAM-Adapter-PyTorch/blob/main/models/mmseg/models/sam/image_encoder.py
        if self.adapter:
        ...
        # include adapter blocks to SAM image encoder
        # https://github.com/tianrun-chen/SAM-Adapter-PyTorch/blob/main/models/mmseg/models/sam/image_encoder.py
...
# helper function for Promptgenerator:
# https://github.com/tianrun-chen/SAM-Adapter-PyTorch/blob/main/models/mmseg/models/sam/image_encoder.py
def to_2tuple(x):
...
# helper functions for Promptgenerator:
# https://github.com/tianrun-chen/SAM-Adapter-PyTorch/blob/main/models/mmseg/models/sam/image_encoder.py
...
# from SAM-Adapter-PyTorch add Promptgenerator to adapt encoder
# https://github.com/tianrun-chen/SAM-Adapter-PyTorch/blob/main/models/mmseg/models/sam/image_encoder.py
...
# from SAM-Adapter-PyTorch add different patch embedding to adapt encoder
# https://github.com/tianrun-chen/SAM-Adapter-PyTorch/blob/main/models/mmseg/models/sam/image_encoder.py
...
# this is original code from segment-anything repository again
